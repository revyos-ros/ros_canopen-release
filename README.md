## ros_canopen (jazzy) - 2.0.0-7

The packages in the `ros_canopen` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy ros_canopen --override-release-repository-push-url git@github.com:revyos-ros/ros_canopen-release` on `Tue, 18 Jun 2024 08:27:19 -0000`
...
- release repository: https://github.com/revyos-ros/ros_canopen-release.git
